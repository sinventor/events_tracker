...
var currentEvent, externalEventDropped, fillEventModalFields, flushEventModalFields, initializeCalendar, refetchEvents;
...
initializeCalendar = function() {
  return $('#userCalendar').fullCalendar({
    ...
    eventDrop: function(data, allDay) {
      return externalEventDropped(data, allDay, this);
    }
  });
};
...
externalEventDropped = function(data, allDay, externalEvent) {
  return $.ajax({
